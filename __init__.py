...
def classFactory(iface):  # pylint: disable=invalid-name
    """Load SpotHeightExtractor_v3 class from file SpotHeightExtractor_v3.

    :param iface: A QGIS interface instance.
    :type iface: QgsInterface
    """
    #
    from .spot_height_extractor import SpotHeightExtractor_v3Plugin
    return SpotHeightExtractor_v3Plugin(iface)
